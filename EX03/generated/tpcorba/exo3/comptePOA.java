	...
	implements org.omg.CORBA.portable.InvokeHandler, tpcorba.exo3.compteOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "_get_nombre_operations", new java.lang.Integer(2));
		m_opsHash.put ( "prelevement", new java.lang.Integer(3));
		m_opsHash.put ( "debiter", new java.lang.Integer(4));
		m_opsHash.put ( "_get_titulaire", new java.lang.Integer(5));
		m_opsHash.put ( "crediter", new java.lang.Integer(6));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 2: // _get_nombre_operations
			{
			_out = handler.createReply();
			_out.write_long(nombre_operations());
				break;
			}
			case 3: // prelevement
			{
